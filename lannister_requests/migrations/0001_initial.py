# Generated by Django 3.2 on 2022-07-18 20:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history_statuses', to='lannister_requests.bonusrequeststatus')),
            ],
            options={
