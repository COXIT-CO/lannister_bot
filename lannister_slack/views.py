    ...
    def post(self, request):
        ...
        # instead of manually typing it out all the time
            ...
            update_slack_ids = requests.patch(
                ...
                json={"slack_channel_id": channel_id},
            )
...
class ListUsersCommandView(APIView):
    ...
    def post(self, request):
        ...
        is_admin = any(item.get("name") == "Administrator" for item in get_current_user["roles"])
        if is_admin:
